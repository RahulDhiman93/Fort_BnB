...
func (m *Repository) PostReservation(w http.ResponseWriter, r *http.Request) {
	...
	roomRestriction := models.RoomsRestriction{
...
// Generals renders the generals quarters landing page
func (m *Repository) Generals(w http.ResponseWriter, r *http.Request) {
	render.Template(w, r, "generals.page.tmpl", &models.TemplateData{})
}

// Majors renders the majors suite landing page
func (m *Repository) Majors(w http.ResponseWriter, r *http.Request) {
	render.Template(w, r, "majors.page.tmpl", &models.TemplateData{})
}

// SearchAvailability renders search page form
func (m *Repository) SearchAvailability(w http.ResponseWriter, r *http.Request) {
	render.Template(w, r, "search-availability.page.tmpl", &models.TemplateData{})
}

// PostSearchAvailability set the page with POST request
...
// AvailabilityJSON handles request for availability and return response
...
// Contact renders contact us page for queries
...
// ChooseRoom displays lists of available room
...
// BookRoom takes URL param, builds a session var. take to reservation screen
...
// PostShowLogin authenticate the user information
func (m *Repository) PostShowLogin(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		m.App.Session.Put(r.Context(), "error", "Invalid user details")
...
// AdminDashboard Redirects to secure admin panel
func (m *Repository) AdminDashboard(w http.ResponseWriter, r *http.Request) {
	render.Template(w, r, "admin-dashboard.page.tmpl", &models.TemplateData{})
}

// AdminAllReservations Shows all reservations made
...
// AdminNewReservations Shows all new reservations made
...
// AdminShowReservation shows a reservation details
...
// AdminPostReservationsCalendar handles post of reservation calendat
